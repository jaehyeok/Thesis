...
\end{tabular} 
\caption{(a) vertex resolution in x and z directions as a function of associated tracks
for data and Simulation and 
(b) vertex reconstruction efficiency as a function of number of associated tracks
in jet-enriched data and min-bias data~\cite{muonTrkPerform}. }
\label{fig:VtxEff} 
\end{figure} 
...
Figure~\ref{fig:jecuncert} shows the uncertainty on the JEC factor
